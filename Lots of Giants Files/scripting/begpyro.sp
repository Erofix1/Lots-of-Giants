...
{
	name = "[TF2] Be the Giant Pyro",
	author = "Erofix using the code from: Pelipoika, PC Gamer, Jaster and StormishJustice",
	description = "Play as the Giant Pyro from MvM",
...
public OnPluginStart()
{
	...
	CreateConVar("begpyro_version", PLUGIN_VERSION, "[TF2] Be the Giant Pyro version", FCVAR_REPLICATED|FCVAR_NOTIFY|FCVAR_PLUGIN|FCVAR_SPONLY);
	
	RegAdminCmd("sm_begpyro", Command_GiantPyro, ADMFLAG_ROOT, "It's a good time to run");
