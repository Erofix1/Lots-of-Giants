...
public OnPluginStart()
{
	...
	RegAdminCmd("sm_begdeknight", Command_GiantDemoKnight, ADMFLAG_ROOT, "It's a good time to run");
...
{
//	CreateNative("BeGiantDemoKnight_MakeGiantDemoKnight", Native_SetGiantDemoKnight);
...
public Action:Command_GiantDemoKnight(client, args)
{
	decl String:arg1[32];
	if (args < 1)
	{
	...
	{
		MakeGiantDemoKnight(target_list[i]);
...
public Native_SetGiantDemoKnight(Handle:plugin, args)
        MakeGiantDemoKnight(GetNativeCell(1));
